	...
	<section class="avada-db-card avada-db-card-first avada-db-support-start">
		...
		<div class="avada-db-card-notice">
			...
			<p class="avada-db-card-notice-heading">
				<a href="https://theme-fusion.com/support/purchase-codes/" target="_blank"><?php esc_html_e( 'Create your support account.', 'Avada' ); ?></a>
			</p>
		</div>
	</section>
	...
	<section class="avada-db-card avada-db-support-channels">
		...
		<div class="avada-db-card-grid">
			...
			<div class="avada-db-card-notice">
				...
				<p class="avada-db-card-notice-content">
					<a href="https://theme-fusion.com/support/submit-a-ticket/" class="button button-primary" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Submit A Ticket', 'Avada' ); ?></a>
				</p>
			</div>
		</div>
		...
		<div class="avada-db-card-grid">
			...
			<div class="avada-db-card-notice">
				...
				<p class="avada-db-card-notice-content">
					<a href="https://theme-fusion.com/community-forum/" class="button button-large button-primary" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Community Forum', 'Avada' ); ?></a>
				</p>
			</div>
