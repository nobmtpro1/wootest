				...
				if ( ! empty( $output ) ) {
					...
					if ( 'yes' === $this->args['lightbox'] || $this->args['link'] ) {
						if ( 'magnify' === $this->args['hover_type'] ) {
							$output = '<a ' . FusionBuilder::attributes( 'image-shortcode-link' ) . ' ' . FusionBuilder::attributes( 'image-magnify' ) . '>' . $output . '</a>';
						} else {
							$output = '<a ' . FusionBuilder::attributes( 'image-shortcode-link' ) . '>' . $output . '</a>';
						}
						$html = '<span ' . FusionBuilder::attributes( 'image-shortcode' ) . ' ' . FusionBuilder::attributes( 'image-scroll' ) . '>' . $output . '</span>';
					} else {
						$html = '<span ' . FusionBuilder::attributes( 'image-shortcode' ) . ' ' . FusionBuilder::attributes( 'image-magnify' ) . ' ' . FusionBuilder::attributes( 'image-scroll' ) . '>' . $output . '</span>';
					}
