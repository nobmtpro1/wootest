	...
	if ( ! class_exists( 'Fusion_Woo_Order_Additional_Info' ) ) {
		...
		class Fusion_Woo_Order_Additional_Info extends Fusion_Woo_Component {
			...
			public function add_css_files() {
				FusionBuilder()->add_element_css( FUSION_BUILDER_PLUGIN_DIR . 'assets/css/shortcodes/woo-order-table.min.css' );
			}
			...
			[
				...
				'params'    => [
					...
					'fusion_animation_placeholder' => [
						'preview_selector' => '.fusion-builder-placeholder-preview',
					],
				],
			]
		)
